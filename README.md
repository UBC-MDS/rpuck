...
#> 1      62      24       59       0.51809               10          64
#> 2      44      27       54       0.37500                9          65
#> 3      56      25       67       0.50000                4          63
#> 4      56      20       48       0.47892                5          58
#> 5      52      23       56       0.42693                4          63
#> 6      55      20       52       0.40816                5          65
#>   goals  lastName otGoals penaltyMinutes playerId plusMinus points
#> 1    37 Draisaitl       2             16  8477934       -11     99
#> 2    46  Pastrnak       1             34  8477956        20     90
#> 3    32   Panarin       0             18  8478550        35     88
#> 4    31   McDavid       0             28  8478402        -7     87
#> 5    33 MacKinnon       2             12  8477492         9     85
#> 6    26  Marchand       0             72  8473419        24     81
#>   pointsPerGame positionCode ppGoals ppPoints shGoals shPoints shootingPct
#> 1       1.54687            C      13       40       0        0     0.18686
#> 2       1.38461            R      19       36       0        0     0.18039
#> 3       1.39682            L       7       21       0        0     0.16494
#> 4       1.50000            C      11       39       0        0     0.16062
#> 5       1.34920            C      10       29       0        0     0.11262
#> 6       1.24615            L       5       26       1        3     0.14857
#>   shootsCatches shots   skaterFullName timeOnIcePerGame
#> 1             L   198   Leon Draisaitl         1361.516
#> 2             R   255   David Pastrnak         1146.369
#> 3             R   194   Artemi Panarin         1219.460
#> 4             L   193   Connor McDavid         1323.000
#> 5             R   293 Nathan MacKinnon         1278.889
#> 6             L   175    Brad Marchand         1178.246
```
...
#>   goalsForPerGame losses otLosses penaltyKillNetPct penaltyKillPct
#> 1          2.8750     49       NA          0.757679       0.733789
#> 2          4.2875     34       NA          0.751445       0.734105
#> 3          4.0125     34       NA          0.798449       0.771318
#> 4          3.8250     35       NA          0.792880       0.754046
#> 5          3.2125     53       NA          0.732323       0.724748
#> 6          3.8875     39       NA          0.767068       0.730924
#>   pointPct points powerPlayNetPct powerPlayPct regulationAndOtWins
#> 1  0.30000     48        0.182119     0.215231                  17
#> 2  0.50000     80        0.185185     0.205387                  34
#> 3  0.48750     78        0.216117     0.238095                  32
#> 4  0.50000     80        0.203821     0.229299                  35
#> 5  0.28125     45        0.183333     0.225000                  18
#> 6  0.46250     74        0.208459     0.229607                  33
#>   seasonId shotsAgainstPerGame shotsForPerGame         teamFullName teamId
#> 1 19821983             32.0875         25.6875    New Jersey Devils      1
#> 2 19821983             32.5375         28.9125     Quebec Nordiques     32
#> 3 19821983             33.0875         28.5875       Calgary Flames     20
#> 4 19821983             29.8000         28.5250     New York Rangers      3
#> 5 19821983             32.6875         30.2250  Pittsburgh Penguins      5
#> 6 19821983             31.6375         31.7625 Winnipeg Jets (1979)     33
#>   ties wins winsInRegulation winsInShootout
#> 1   14   17               17              0
#> 2   12   34               34              0
#> 3   14   32               32              0
#> 4   10   35               35              0
